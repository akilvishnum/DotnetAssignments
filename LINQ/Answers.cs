...
class Answers
{
    ...
    private static void PopulateLists(out List<Order> OrderList, out List<Item> ItemList)
    {
        ...
        OrderList.Add(new Order(1, "a", "2/10/21", 40)); ItemList.Add(new Item("a", 5.0));
        OrderList.Add(new Order(2, "b", "13/7/22", 140)); ItemList.Add(new Item("b", 7.5));
        OrderList.Add(new Order(3, "c", "27/6/22", 510)); ItemList.Add(new Item("c", 2.0));
        OrderList.Add(new Order(4, "d", "11/10/22", 720)); ItemList.Add(new Item("d", 10.0));
        OrderList.Add(new Order(5, "e", "12/10/22", 873)); ItemList.Add(new Item("e", 6.0));
        OrderList.Add(new Order(6, "f", "15/9/22", 544)); ItemList.Add(new Item("f", 2.5));
        OrderList.Add(new Order(7, "g", "24/9/22", 344)); ItemList.Add(new Item("g", 3.5));
        OrderList.Add(new Order(8, "h", "11/8/22", 835)); ItemList.Add(new Item("h", 4.5));
    }
